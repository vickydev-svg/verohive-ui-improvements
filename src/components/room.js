...
export default class Room extends React.Component{
	...
	componentDidMount(){
		this.setState({
			...
			code:this.props.location.state.room_code
		})
		if( this.props.location.state.type != 'host'){
		...
		this.setState({
			...
			let peerConnections = [];
			console.log("Ff",this.props.location.state.room_code)
			const data = {
	...
	render(){
		...
		return(
			<>	
				...
				{/* {this.state.viewing == false &&  this.state.type == 'client' &&
