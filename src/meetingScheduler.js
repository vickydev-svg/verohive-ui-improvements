        ...
        return (
            <div className="home-main">
                <div className="header">
                    ...
                    <img src={logo} className='logo-vero'></img><h4 style={{ color: 'white', marginRight: '45%' }}>Beta Version 1.0</h4>
                </div>
      ...
      image1: null
          ...
          Welcome {this.state.id} </h4>
                    ...
                    <ul className="sidebar-ui">
                        ...
                        <li  ><a className=" btn-profile " href="https://whiteboard.verohive.org/" target="_blank">Whiteboard</a></li>
                        <li ><a className=" btn-profile " href="https://screenshare.verohive.org/" target="_blank">Screenshare</a></li>


                        <li><a
                            className=" btn-profile "
                            onClick={() => this.recording()}>Recording</a></li>
                        <li><a
                            className=" btn-profile "
